...
function Table() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        'https://api.p360.build:6060/v1/fundflow/p2r-surplus-fund-transfer/fetchAll',
        Cookie
  ...
  const handleSaveRow = async (index) => {
    ...
    try {
      ...
      if (rowToSave.id) {
        ...
        await axios.put(
          `https://api.p360.build:6060/v1/fundflow/p2r-surplus-fund-transfer/submit`,
        ...
        await axios.post(
          'https://api.p360.build:6060/v1/fundflow/p2r-surplus-fund-transfer/draft',
          rowToSave, // Send the rowToSave object directly as the request body
          Cookie
        );
      }
  ...
  return (
    <div>
      ...
      >
        <div>
          <h2>P2R Surplus Funds Transfer</h2>
        </div>
        <div>
