  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        'https://api.p360.build:6060/v1/fundflow/termloansetoff/fetchAll',
        Cookie
  ...
  const handleSaveRow = async (index) => {
    ...
    try {
      ...
      if (rowToSave.id) {
        ...
        await axios.put(
          `https://api.p360.build:6060/v1/fundflow/termloansetoff/submit`,
        ...
        await axios.post(
          'https://api.p360.build:6060/v1/fundflow/termloansetoff/draft',
          rowToSave, // Send the rowToSave object directly as the request body
          Cookie
        );
      }
